...
{-27.940196990967, -89.615165710449, 1003.546875, int= 18, dim = 0, items={"Telefono", "Agenda","Radio","Parlante", "Cuchillo de Caza (Arma)", "Lata de Spray", "Caja de Cigarros", "Encendedor", "Cámara", "Cerveza", "Agua"}},
