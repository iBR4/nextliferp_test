	...
	if ( hasObjectPermissionTo ( source, "command."..action ) ) then
		...
		elseif ( action == "setnick" )  then
			...
			if setPlayerName( player, data ) then
				outputChatBox( "#FFFF00"..playername.."#FFFFFF ahora es conocido como #FFFF00"..data.."#FFFFFF.", root, 0, 255, 0, true)
				exports["Logs-NOMBRES"]:sendDiscordLogMessage("**"..playername.."** ahora es conocido como **"..data.."**.", source)
			else
