				...
				if tonumber(who) then
					...
					if (thePlayer) then
						...
						if div ~="" and div ~=" " then
							...
							if div:find("S.W.A.T") or div:find("CEI") or div:find("s.w.a.t") or div:find("cei") then
								...
								player:outputChat("#3A63FF[LSPD] #ffffffDivisiones disponibles S.W.A.T y CEI", 150, 50, 50, true)
