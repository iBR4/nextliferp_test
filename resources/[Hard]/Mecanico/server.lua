...
2509.9050292969, -1539.4592285156, 24.54062461853}
}
...
if getElementData(source,"Roleplay:faccion") == "Mecanico" then
		...
		if getDistanceBetweenPoints3D(x,y,z,mecashapes[4][1],mecashapes[4][2],mecashapes[4][3]) < 14 then
...
addCommandHandler("repararmotor",
function(source,cmd)
if getElementData(source,"Roleplay:faccion") == "Mecanico" then
	local x,y,z = getElementPosition(source)
	if getDistanceBetweenPoints3D(x,y,z,mecashapes[4][1],mecashapes[4][2],mecashapes[4][3]) < 14 then
