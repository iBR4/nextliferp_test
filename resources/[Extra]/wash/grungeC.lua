...
grungeTextures[1] = dxCreateTexture("files/images/default/nogrunge.jpg")
grungeTextures[2] = dxCreateTexture("files/images/default/lowgrunge.jpg")
grungeTextures[3] = dxCreateTexture("files/images/default/defaultgrunge.jpg")
grungeTextures[4] = dxCreateTexture("files/images/default/biggrunge.jpg")
grungeTextures[5] = dxCreateTexture("files/images/default/megagrunge.jpg")
    ...
    function(oldLevel, newLevel)
		if debugEnabled then
			if source and isElement(source) then
				outputChatBox("#961919[CLIENT EVENT] #FFFFFF" .. getVehicleName(source) .. ", old dirt level: #2399dd" .. oldLevel .. "#FFFFFF, new dirt level: #d7b428" .. newLevel,localPlayer, 255, 255, 255, true)
			end
		end
    end
)
