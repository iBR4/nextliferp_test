...
modShops[ 1 ].marker = createMarker(487.41061401367, -1740.3624267578, 10.8, "cylinder", 5, 223, 223, 223, 100 )
modShops[ 1 ].name = "Mecanicos"

createBlip(487.41061401367, -1740.3624267578, 11.132981300354, 23, 2, 255, 0, 0, 255, 0, 200, getRootElement() )
